				...
				<div class="sticky-wrapp">
					<div class="sticky-container">
						...
						<section id="logo" class="logo">
							<div>
								<a href="index-2.html"><img src="img/blue/logo.png" alt="Clinico"></a>
							</div>
						</section>
						<!--/ logo -->
						...
						<nav class="main-nav">
							<ul>
								<li>
									<a href="index-2.html" class="active"><i class="fa fa-plus"></i>Home</a>
									<ul>
										<li>
								...
								<li class="right">
									<a href="index-2.html"><i class="fa fa-plus"></i>Features</a>
									<ul>
				...
				<div class="grid-row">
					...
					<div class="grid-col grid-col-4">
						...
						<section class="widget widget-appointment">
							...
							<form action="http://html.cwsthemes.com/clinico/php/contact-send.php" id="contactform">
								<fieldset>
									<div class="row">
...
<!-- Mirrored from html.cwsthemes.com/clinico/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2019 09:00:20 GMT -->
</html>